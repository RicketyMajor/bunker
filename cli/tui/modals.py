...
# Los seis modales de ajedrez (ImportPGN, CreateGame, CreateVariation, SelectVariation,
# ChessNote, ChessDir) estaban aquí hasta el 2026-08-27. Se fueron con el repositorio de El
# Ajedrez, donde son lo único que su TUI no declara en su propia pantalla.
