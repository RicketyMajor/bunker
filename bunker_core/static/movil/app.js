...
const App = (() => {
  ...
  return {
    ...
    // Exported to be driven: it is the only arithmetic in this file that can be wrong in a way
    // the interface would not show, and app.js has no harness of its own — /movil/selftest/
    // loads queue.js and nothing else.
